        ...
        <div>
            ...
            <div style={{
                ...
                <article style={{
                    ...
                    <hr />
                    <ol dir="rtl">
                        <li>סרטון חדש בנושא מבנה נתונים - בבל סורט</li> <br/>
                        <li>סרטון חדש בנושא ריאקט</li> <br/>
                        <li>סרטון חדש בנושא ריאקט - קלאס קומפוננט</li> <br/>
                        <li> סרטון חדש בנושא ריאקט - עיצוב</li> <br/>
