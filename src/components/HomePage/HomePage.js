        ...
        <div>
            ...
            <div style={{
                ...
                <article style={{
                    ...
                    <hr />
                    <ol dir="rtl">
                        <li>סרטון חדש בנושא השיעורים האחרונים בספרינג </li><br/>
                        <li>סרטון חדש בנושא תכנות פונקציונלי </li> <br/>
                        <li>שני סרטונים חדשים תחת קטגוריה דיזיין פטרנס</li> <br/>
                        <li>שני סרטונים חדשים אחד על סינגלטון והשני בספרינג</li> <br/>
                        <li>עוד סרטון חדש המתקשר לסרטון הקודם בנושא ספרינג</li>
